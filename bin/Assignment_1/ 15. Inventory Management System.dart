...
void main() {
  ...
  inventory.addProduct(Product(id: 1, name: 'Laptop', quantity: 10, price: 999.99));
  inventory.addProduct(Product(id: 2, name: 'Smartphone', quantity: 50, price: 499.99));
  inventory.addProduct(Product(id: 3, name: 'Headphones', quantity: 30, price: 79.99));
